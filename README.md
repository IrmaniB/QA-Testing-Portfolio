...
17 manual test cases executed across public websites
15 passed / 2 failed
4 defects documented
...
Git & GitHub
Excel
XPath, IDs, and accessible element attributes
Explicit waits and expected conditions
Assertions and result validation
JavaScript interaction fallbacks when standard browser interaction is blocked
...
**Current Development**
I am continuing to expand this portfolio with additional QA skills, including:
API testing with Postman
SQL-based data validation
More structured Selenium automation
Additional regression and negative test coverage
...
**Portfolio note:** These projects were created for learning and professional portfolio purposes using publicly accessible websites. Results reflect behavior observed during testing and may change as those websites are updated.
